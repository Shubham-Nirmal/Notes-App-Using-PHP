...
<div style="max-width: 400px; margin: 20px auto;">
  <form action="" method="post">
    ...
    <button type="submit" style="padding: 10px 15px; background-color: #0d6efd; color: white; border: none;">Add Note</button>
  </form>
</div>
      ...
      <?php  
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          echo "<tr>
                  ...
                  <td>
                    <button class='editBtn' data-sno='".$row['sno']."' style='padding:5px 10px; background:#ffc107; color:#fff; border:none;'>Edit</button>
                    <button class='deleteBtn' data-sno='".$row['sno']."' style='padding:5px 10px; background:#dc3545; color:#fff; border:none;'>Delete</button>
                  </td>
                </tr>";
        }
      ?>
...
<!-- ========== EDIT MODAL ========== -->
<div id="editModal" style="display:none; position: fixed; top: 10%; left: 50%; transform: translateX(-50%); background: white; padding: 20px; border: 2px solid #ccc; border-radius: 10px; z-index: 1000;">
  <form action="" method="post">
    <input type="hidden" name="snoEdit" id="snoEdit">
    <label>Title</label><br>
    <input type="text" name="titleEdit" id="titleEdit" required style="width:100%; padding: 8px;"><br><br>
    <label>Description</label><br>
    <textarea name="descriptionEdit" id="descriptionEdit" required style="width:100%; padding: 8px;"></textarea><br><br>
    <button type="submit" style="background-color: #0d6efd; color: white; padding: 8px 16px; border: none;">Update</button>
    <button type="button" onclick="closeModal()" style="margin-left: 10px; background-color: #6c757d; color: white; padding: 8px 16px; border: none;">Cancel</button>
  </form>
</div>
